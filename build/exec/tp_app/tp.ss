...
(define csegen-29 (cons (lambda (arg-676) (lambda (arg-679) (PreludeC-45EqOrd-u--C-61C-61_Eq_String arg-676 arg-679))) (lambda (arg-686) (lambda (arg-689) (PreludeC-45EqOrd-u--C-47C-61_Eq_String arg-686 arg-689)))))
...
(define Converter-wordsBy (lambda (arg-0 arg-1) (let ((u--chars (PreludeC-45Types-fastUnpack arg-1))) (let ((u--groups (Converter-groupOn (cons (lambda (arg-676) (lambda (arg-679) (PreludeC-45EqOrd-u--C-61C-61_Eq_Bool arg-676 arg-679))) (lambda (arg-686) (lambda (arg-689) (PreludeC-45EqOrd-u--C-47C-61_Eq_Bool arg-686 arg-689)))) (lambda (arg-2) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-2 arg-0)) u--chars))) (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (PreludeC-45Types-fastPack eta-0)) (PreludeC-45TypesC-45List-filterAppend '() (lambda (eta-0) (let ((sc0 (PreludeC-45Types-u--null_Foldable_List eta-0))) (cond ((equal? sc0 1) 0) (else 1)))) u--groups))))))
(define Converter-csv2table (lambda (arg-0 arg-1) (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (Converter-wordsBy arg-0 eta-0)) (DataC-45String-lines arg-1))))
(define Converter-prepend (lambda (arg-1 arg-2 arg-3) (cons (let ((e-1 (car arg-1))) (e-1 arg-2)) arg-3)))
(define Converter-prependC-39 (lambda (arg-1 arg-2) (let ((e-2 (car arg-2))) (let ((e-3 (cdr arg-2))) (Converter-prepend arg-1 e-2 e-3)))))
(define Converter-natsFrom (lambda (arg-0) (cons arg-0 (lambda () (Converter-natsFrom (+ arg-0 1))))))
(define Converter-zipC-39 (lambda (arg-2 arg-3) (if (null? arg-3) '() (if (null? arg-2) '() (let ((e-2 (car arg-2))) (let ((e-3 (cdr arg-2))) (let ((e-5 (car arg-3))) (let ((e-6 (cdr arg-3))) (cons (cons e-2 e-5) (Converter-zipC-39 (e-3) e-6))))))))))
(define Converter-zipWithRank (lambda (arg-1) (if (null? arg-1) '() (Converter-zipC-39 (Converter-natsFrom 1) arg-1))))
...
(define Converter-addRowNumbers (lambda (arg-0) (let ((u--numberedRows (Converter-zipWithRank arg-0))) (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (Converter-prependC-39 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_Nat u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_Nat u--d u--x)))) eta-0)) u--numberedRows))))
...
(define Converter-groupOnColumn (lambda (arg-0 arg-1) (Converter-groupOn csegen-29 (lambda (u--row) (Converter-C-33C-33 u--row arg-0)) arg-1)))
...
(define Converter-row2html (lambda (arg-0) (string-append "<tr>" (string-append (PreludeC-45Types-u--foldMap_Foldable_List csegen-8 (lambda (u--cell) (string-append "<td>" (string-append u--cell "</td>"))) arg-0) "</tr>"))))
(define Converter-table2html (lambda (arg-0) (string-append "<table>" (string-append (PreludeC-45Types-u--foldMap_Foldable_List csegen-8 (lambda (eta-0) (Converter-row2html eta-0)) arg-0) "</table>"))))
...
(define Converter-processFile (lambda (arg-0 arg-1 arg-2 ext-0) (let ((act-1 ((SystemC-45FileC-45ReadWrite-readFile csegen-26 arg-1) ext-0))) (case (vector-ref act-1 0) ((1) (let ((e-2 (vector-ref act-1 1))) (let ((act-2 ((SystemC-45FileC-45ReadWrite-writeFile csegen-26 arg-2 (arg-0 e-2)) ext-0))) (case (vector-ref act-2 0) ((1) (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_String "OK") "\xa;") ext-0)) (else (let ((e-5 (vector-ref act-2 1))) (PreludeC-45IO-prim__putStr (string-append (SystemC-45FileC-45Error-u--show_Show_FileError e-5) "\xa;") ext-0))))))) (else (let ((e-5 (vector-ref act-1 1))) (PreludeC-45IO-prim__putStr (string-append (SystemC-45FileC-45Error-u--show_Show_FileError e-5) "\xa;") ext-0)))))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Bienvenue au TP  Table.\xa;" ext-0))) (let ((act-2 (Converter-processFile (lambda (eta-0) (Converter-process eta-0)) "marks.csv" "marks.html" ext-0))) (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_C-40ListC-32C-36aC-41 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_String u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_String u--d u--x)))) (Converter-wordsBy #\; "5;Charles Darwin;20")) "\xa;") ext-0)))))
