...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Bienvenue au TP  Table.\xa;" ext-0))) (((let ((u--table1 (cons (cons "1" (cons "c" '())) (cons (cons "2" (cons "a" '())) (cons (cons "3" (cons "b" '())) '()))))) (lambda () (lambda (world-0) (let ((act-2 (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_C-40ListC-32C-36aC-41 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_C-40ListC-32C-36aC-41 csegen-7 u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_C-40ListC-32C-36aC-41 csegen-7 u--d u--x)))) (Converter-sortTable (lambda (eta-0) (lambda (eta-1) (PreludeC-45EqOrd-u--C-60C-61_Ord_String eta-0 eta-1))) 1 u--table1)) "\xa;") world-0))) (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_Double (Converter-readDouble " 4.5 ")) "\xa;") world-0)))))) ext-0))))
