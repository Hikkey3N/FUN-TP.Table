...
(define csegen-1 (cons "5" (cons "Charles Darwin" (cons "20" '()))))
...
(define csegen-7 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_String u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_String u--d u--x)))))
(define csegen-13 (cons (lambda (arg-8474) (lambda (arg-8477) (string-append arg-8474 arg-8477))) ""))
...
(define Converter-row2html (lambda (arg-0) (string-append "<tr>" (string-append (PreludeC-45Types-u--foldMap_Foldable_List csegen-13 (lambda (u--cell) (string-append "<td>" (string-append u--cell "</td>"))) arg-0) "</tr>"))))
(define Converter-table2html (lambda (arg-0) (string-append "<table>" (string-append (PreludeC-45Types-u--foldMap_Foldable_List csegen-13 (lambda (eta-0) (Converter-row2html eta-0)) arg-0) "</table>"))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Bienvenue au TP  Table.\xa;" ext-0))) (((let ((u--row2 csegen-1)) (lambda () (lambda (world-0) (let ((act-2 (PreludeC-45IO-prim__putStr (string-append (Converter-row2html u--row2) "\xa;") world-0))) (((let ((u--table6 (cons csegen-1 (cons (cons "8" (cons "Russel Wallace" (cons "18" '()))) '())))) (lambda () (lambda (world-1) (let ((act-3 (PreludeC-45IO-prim__putStr (string-append (Converter-table2html u--table6) "\xa;") world-1))) (let ((act-4 (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_C-40ListC-32C-36aC-41 csegen-7 (Converter-wordsBy #\; "5;Charles Darwin;20")) "\xa;") world-1))) (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_C-40ListC-32C-36aC-41 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_C-40ListC-32C-36aC-41 csegen-7 u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_C-40ListC-32C-36aC-41 csegen-7 u--d u--x)))) (Converter-csv2table #\; (PreludeC-45Types-u--foldMap_Foldable_List csegen-13 (lambda (eta-0) eta-0) (cons "Alan Turing;19.5\xa;Alonzo Church;20\xa;Bertrand Russell;18\xa;Dana Scott;19\xa;Haskell Curry;20\xa;Kurt Godel;17.5\xa;Per Martin-Lof;18\xa;Thierry Coquand;18\xa;Wilhelm Ackermann;16" '())))) "\xa;") world-1))))))) world-0)))))) ext-0))))
