...
(define csegen-27 (cons (lambda (arg-676) (lambda (arg-679) (PreludeC-45EqOrd-u--C-61C-61_Eq_String arg-676 arg-679))) (lambda (arg-686) (lambda (arg-689) (PreludeC-45EqOrd-u--C-47C-61_Eq_String arg-686 arg-689)))))
...
(define Converter-wordsBy (lambda (arg-0 arg-1) (let ((u--chars (PreludeC-45Types-fastUnpack arg-1))) (let ((u--groups (Converter-groupOn (cons (lambda (arg-676) (lambda (arg-679) (PreludeC-45EqOrd-u--C-61C-61_Eq_Bool arg-676 arg-679))) (lambda (arg-686) (lambda (arg-689) (PreludeC-45EqOrd-u--C-47C-61_Eq_Bool arg-686 arg-689)))) (lambda (arg-2) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-2 arg-0)) u--chars))) (let ((u--filteredGroups (PreludeC-45TypesC-45List-filterAppend '() (lambda (u--g) (let ((sc0 (PreludeC-45Types-u--foldMap_Foldable_List (cons (lambda (arg-8474) (lambda (arg-8477) (PreludeC-45InterfacesC-45BoolC-45Semigroup-u--C-60C-43C-62_Semigroup_AllBool arg-8474 arg-8477))) 1) (lambda (arg-2) (PreludeC-45EqOrd-u--C-61C-61_Eq_Char arg-2 arg-0)) u--g))) (cond ((equal? sc0 1) 0) (else 1)))) u--groups))) (PreludeC-45TypesC-45List-mapAppend '() (lambda (eta-0) (PreludeC-45Types-fastPack eta-0)) u--filteredGroups))))))
...
(define Converter-groupOnColumn (lambda (arg-0 arg-1) (Converter-groupOn csegen-27 (lambda (u--row) (Converter-C-33C-33 u--row arg-0)) arg-1)))
...
(define Converter-row2html (lambda (arg-0) (string-append "<tr>" (string-append (PreludeC-45Types-u--foldMap_Foldable_List csegen-6 (lambda (u--cell) (string-append "<td>" (string-append u--cell "</td>"))) arg-0) "</tr>"))))
(define Converter-table2html (lambda (arg-0) (string-append "<table>" (string-append (PreludeC-45Types-u--foldMap_Foldable_List csegen-6 (lambda (eta-0) (Converter-row2html eta-0)) arg-0) "</table>"))))
