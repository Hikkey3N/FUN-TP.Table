...
(define csegen-19 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_String u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_String u--d u--x)))))
...
(define (Converter-groupOn . any-args) (blodwen-error-quit "Encountered undefined name Converter.groupOn"))
...
(define Converter-groupOnColumn (lambda (arg-0 arg-1) ((((((Converter-groupOn) 'erased) 'erased) (cons (lambda (arg-676) (lambda (arg-679) (PreludeC-45EqOrd-u--C-61C-61_Eq_String arg-676 arg-679))) (lambda (arg-686) (lambda (arg-689) (PreludeC-45EqOrd-u--C-47C-61_Eq_String arg-686 arg-689))))) (lambda (u--row) (Converter-C-33C-33 u--row arg-0))) arg-1)))
...
(define Main-main (lambda (ext-0) (let ((act-1 (PreludeC-45IO-prim__putStr "Bienvenue au TP  Table.\xa;" ext-0))) (((let ((u--table5 (cons (cons "Alan Turing" (cons "19.5" '())) (cons (cons "Alonzo Church" (cons "20" '())) (cons (cons "Bertrand Russell" (cons "18" '())) (cons (cons "Dana Scott" (cons "19" '())) (cons (cons "Haskell Curry" (cons "20" '())) (cons (cons "Kurt Godel" (cons "17.5" '())) (cons (cons "Per Martin-Lof" (cons "18" '())) (cons (cons "Thierry Coquand" (cons "18" '())) (cons (cons "Wilhelm Ackermann" (cons "16" '())) '()))))))))))) (lambda () (lambda (eta-0) (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_C-40ListC-32C-36aC-41 (cons (lambda (u--x) (PreludeC-45Show-u--show_Show_C-40ListC-32C-36aC-41 csegen-19 u--x)) (lambda (u--d) (lambda (u--x) (PreludeC-45Show-u--showPrec_Show_C-40ListC-32C-36aC-41 csegen-19 u--d u--x)))) (Converter-ranks 1 u--table5)) "\xa;") eta-0))))) ext-0))))
